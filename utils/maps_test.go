...
func TestOrderedListFromMap(t *testing.T) {
	...
	inputMap := map[string]any{
		"value1": map[string]any{"name": "resource1", "attr": "value1"},
		"value3": map[string]any{"name": "resource3", "attr": "value3"},
		"value2": map[string]any{"name": "resource2", "attr": "value2"},
	}

	expected := []any{
		map[string]any{"name": "resource1", "attr": "value1"},
		map[string]any{"name": "resource2", "attr": "value2"},
		map[string]any{"name": "resource3", "attr": "value3"},
	}
...
func TestMapResourceList(t *testing.T) {
	...
	resourceList := []any{
		...
		nil,
		map[string]any{"name": "resource3", "attr": "value3"},
		map[string]any{"name": "resource4", "attr": "value4"},
	}
...
func TestOrderedListFromMapByKeyValues(t *testing.T) {
	...
	expected := []any{"value2", "value1", "value4"}

...
//go:generate cp ./build/docs-gen/data-sources/virtual_environment_backup_jobs.md ./docs/data-sources/
...
//go:generate cp ./build/docs-gen/resources/virtual_environment_backup_job.md ./docs/resources/

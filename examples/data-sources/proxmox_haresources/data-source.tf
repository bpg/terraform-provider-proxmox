...
data "proxmox_haresources" "example_vm" {
  type = "vm"
}

output "data_proxmox_haresources" {
  value = {
    all = data.proxmox_haresources.example_all.resource_ids
    vms = data.proxmox_haresources.example_vm.resource_ids
  }
}

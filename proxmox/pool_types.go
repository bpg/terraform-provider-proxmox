...
// PoolCreateRequestBody contains the data for an pool create request.
type PoolCreateRequestBody struct {
	Comment *string `json:"comment,omitempty" url:"comment,omitempty"`
	ID      string  `json:"groupid"           url:"poolid"`
}

// PoolGetResponseBody contains the body from an pool get response.
type PoolGetResponseBody struct {
	Data *PoolGetResponseData `json:"data,omitempty"`
}

// PoolGetResponseData contains the data from an pool get response.
...
// PoolListResponseBody contains the body from an pool list response.
type PoolListResponseBody struct {
	Data []*PoolListResponseData `json:"data,omitempty"`
}

// PoolListResponseData contains the data from an pool list response.

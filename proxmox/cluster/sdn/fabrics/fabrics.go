...
func (c *Client) UpdateFabric(ctx context.Context, id string, data *FabricUpdate) error {
	err := c.DoRequest(ctx, http.MethodPut, c.ExpandPath(id), data, nil)
	if err != nil {

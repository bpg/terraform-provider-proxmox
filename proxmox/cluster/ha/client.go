...
// Rules returns a client for managing the cluster's High Availability rules (PVE 9+).
func (c *Client) Rules() *harules.Client {
	return &harules.Client{Client: c.Client}
}

...
- `pool_id` - (Optional, **Deprecated**) The identifier for a pool to assign the container to.
  This field is deprecated and will be removed in a future release. To assign the container to a pool, use `proxmox_virtual_environment_pool_membership` resource instead. 

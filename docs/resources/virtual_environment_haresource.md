...
~> **Deprecated:** Use [`proxmox_haresource`](haresource.md) instead. This resource will be removed in v1.0.
...
- `auto_rebalance` (Boolean) Whether this HA resource may be migrated during automatic rebalancing (Proxmox VE 9.2+). Leave unset to use the cluster default.

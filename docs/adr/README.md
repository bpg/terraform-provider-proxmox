...
| [004](004-schema-design-conventions.md)    | Schema Design Conventions    | Attribute types, validators, model-API conversion, `CheckDelete`, PVE-defaults rule                                   |
...
| [008](008-sub-block-contract.md)           | Sub-block Contract           | Value-centric `NewValue` / `FillCreateBody` / `FillUpdateBody` shape for sub-packages of VM-style composite resources |
...
4. **[ADR-004](004-schema-design-conventions.md)** — Schema attributes, model conversion, field deletion, PVE-defaults rule
...
7. **[ADR-008](008-sub-block-contract.md)** — _Only if_ the resource composes sub-packages (VM-style). Skip otherwise.
8. **[reference-examples.md](reference-examples.md)** — Copy-from code walkthroughs and checklist
